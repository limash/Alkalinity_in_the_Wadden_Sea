...
knh4_lim=0.5; knox_lim=1; ksi_lim=0.5; kpo4_lim=1; pbm=8; alpha=0.05; kexc=0; kmortality=0

het = np.zeros(365); het[0] = 0.1
k_het_phy_gro=0.41; k_het_phy_lim=1.1; k_het_pom_gro=0.5; k_het_pom_lim=1.1
