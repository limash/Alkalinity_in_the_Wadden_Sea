...
```{python}
ds1 = xr.open_dataset('data/low_sulfate_reduction_rate/1_po75-25_di5e-8/water.nc')
ds2 = xr.open_dataset('data/low_sulfate_reduction_rate/2_po75-25_di4e-8/water.nc')
ds3 = xr.open_dataset('data/low_sulfate_reduction_rate/3_po75-25_di3e-8/water.nc')
ds4 = xr.open_dataset('data/low_sulfate_reduction_rate/4_po75-25_di2e-8/water.nc')
ds5 = xr.open_dataset('data/low_sulfate_reduction_rate/5_po75-25_di1e-8/water.nc')
ds6 = xr.open_dataset('data/low_sulfate_reduction_rate/6_po75-25_di9e-9/water.nc')
ds7 = xr.open_dataset('data/low_sulfate_reduction_rate/7_po75-25_di8e-9/water.nc')
ds8 = xr.open_dataset('data/low_sulfate_reduction_rate/8_po75-25_di7e-9/water.nc')
ds9 = xr.open_dataset('data/low_sulfate_reduction_rate/9_po75-25_di6e-9/water.nc')
ds10 = xr.open_dataset('data/low_sulfate_reduction_rate/10_po75-25_di5e-9/water.nc')
ds11 = xr.open_dataset('data/low_sulfate_reduction_rate/11_po75-25_di4e-9/water.nc')
ds12 = xr.open_dataset('data/low_sulfate_reduction_rate/12_po75-25_di3e-9/water.nc')
ds13 = xr.open_dataset('data/low_sulfate_reduction_rate/13_po75-25_di2e-9/water.nc')
```
...
ax.plot(alk_year[7]['time'], alk_year[7]['B_C_Alk'], linewidth=2, label=r'$7e-9$')
ax.plot(alk_year[8]['time'], alk_year[8]['B_C_Alk'], linewidth=2, label=r'$6e-9$')
ax.plot(alk_year[9]['time'], alk_year[9]['B_C_Alk'], linewidth=2, label=r'$5e-9$')
ax.plot(alk_year[10]['time'], alk_year[10]['B_C_Alk'], linewidth=2, label=r'$4e-9$')
ax.plot(alk_year[11]['time'], alk_year[11]['B_C_Alk'], linewidth=2, label=r'$3e-9$')
ax.plot(alk_year[12]['time'], alk_year[12]['B_C_Alk'], linewidth=2, label=r'$2e-9$')
