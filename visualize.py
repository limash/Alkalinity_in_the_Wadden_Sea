...
def plot_alkalinity_high():
    ...
    ds1 = xr.open_dataset('data/high_sulfate_reduction_rate/1_po75-25_di2e-9/water.nc')
    ds2 = xr.open_dataset('data/high_sulfate_reduction_rate/2_po75-25_di6e-9/water.nc')
    ds3 = xr.open_dataset('data/high_sulfate_reduction_rate/3_po75-25_di10e-9/water.nc')
    ds4 = xr.open_dataset('data/high_sulfate_reduction_rate/4_po75-25_di14e-9/water.nc')
    ds5 = xr.open_dataset('data/high_sulfate_reduction_rate/5_po75-25_di18e-9/water.nc')
    ds6 = xr.open_dataset('data/high_sulfate_reduction_rate/6_po75-25_di24e-9/water.nc')
    ds7 = xr.open_dataset('data/high_sulfate_reduction_rate/7_po75-25_di28e-9/water.nc')
    ds8 = xr.open_dataset('data/high_sulfate_reduction_rate/8_po75-25_di35e-9/water.nc')
    ds9 = xr.open_dataset('data/high_sulfate_reduction_rate/9_po75-25_di45e-9/water.nc')
