...
Phototrophic producers mortality Phy$_{mortality}$ = $K_{phy\_mortality} \cdot$[Phy]$\cdot$[Phy] where $K_{phy\_mortality}$ is the phytoplankton mortality coefficient.
...
Therefore with sufficient oxygen concentrations ($[$O$_{2}] > Ks_{het\_oxygen}$) respiration and mortality of heterotrophs depend on corresponding coefficients $K_{het\_respiration}$ and $K_{het\_mortality}$, otherwise respiration tends to zero and mortality tends to be equal to the heterotrophs biomass [Het].
